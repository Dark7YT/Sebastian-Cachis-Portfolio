...
import { useTheme } from '../../../hooks/useTheme'; // Ajusta ruta
...
export const TopBarControls = () => {
  ...
  return (
    <div className="flex items-center space-x-1 sm:space-x-2">
      ...
      >
        {/* Para móvil, el icono de Languages podría ser suficiente o quitarse si el espacio es muy limitado */}
        <Languages className="h-3.5 w-3.5 sm:h-4 sm:w-4 mr-0.5 sm:mr-1 flex-shrink-0" /> {/* Icono más pequeño en base, crece en sm */}
        <AnimatePresence mode="wait" initial={false}>
          <motion.span 
